  ...
  <div class="navbar w-full border-b">
    <div class="flex gap-2 w-full">
      ...
      <div class="w-1/5">
        ...
        <button
          class="btn btn-circle btn-outline btn-sm btn-primary me-3"
          @click="startTask"
        >
